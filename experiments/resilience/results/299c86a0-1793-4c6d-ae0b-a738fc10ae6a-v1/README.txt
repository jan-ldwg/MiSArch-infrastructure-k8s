...
Experiment: 299c86a0-1793-4c6d-ae0b-a738fc10ae6a (v1)
Exported:   2026-06-09T09:19:28Z
...
Example Flux filter:
  from(bucket:"gatling")
    |> range(start: -24h)
    |> filter(fn: (r) => r.testUUID == "299c86a0-1793-4c6d-ae0b-a738fc10ae6a" and r.testVersion == "v1")
