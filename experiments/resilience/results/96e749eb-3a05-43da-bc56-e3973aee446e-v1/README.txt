...
Experiment: 96e749eb-3a05-43da-bc56-e3973aee446e (v1)
Exported:   2026-06-09T08:54:09Z
...
Example Flux filter:
  from(bucket:"gatling")
    |> range(start: -24h)
    |> filter(fn: (r) => r.testUUID == "96e749eb-3a05-43da-bc56-e3973aee446e" and r.testVersion == "v1")
