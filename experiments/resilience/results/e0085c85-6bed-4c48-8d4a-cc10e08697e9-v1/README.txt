...
Experiment: e0085c85-6bed-4c48-8d4a-cc10e08697e9 (v1)
Exported:   2026-06-09T09:02:50Z
...
Example Flux filter:
  from(bucket:"gatling")
    |> range(start: -24h)
    |> filter(fn: (r) => r.testUUID == "e0085c85-6bed-4c48-8d4a-cc10e08697e9" and r.testVersion == "v1")
